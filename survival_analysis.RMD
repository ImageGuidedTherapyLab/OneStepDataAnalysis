...
ROCdropcensor <- roc(response = resultsClass$obs, levels = timelabs, predictor = resultsClass[,timelabs[length(timelabs)]])
print(ROCdropcensor)
plot(ROCdropcensor, main="Only observations used for model building") 
print("")
