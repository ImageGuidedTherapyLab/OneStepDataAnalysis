...
if(! is.null(params$status)){
  ...
  weightList <- datClass[, trainingWeights]
}
...
if(!is.null(params$foldID)){
  ...
  print(roc(datFull[,survival] < 100, datFull[,finalpredname] ))
  plot(roc(datFull[,survival] < 100, datFull[,finalpredname] ))
print("")
...
PR1 <- pr.curve(weights.class0=as.numeric(datFull[!is.na(datFull[,finalpredname]),survival] < 100), scores.class0=na.omit(datFull[,finalpredname]), curve=T)
